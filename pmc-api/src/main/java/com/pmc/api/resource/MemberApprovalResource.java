...
public class MemberApprovalResource {
    ...
    public ResponseEntity<OperationResult<MemberRecordDto>> approveMember(@RequestParam String regToken,
            @RequestParam @DateTimeFormat(pattern = DateUtil.DATETIME_FORMAT) DateTime expirationDate) {
    ...
    public ResponseEntity<OperationResult<MemberRecordDto>> renewMember(@RequestParam String regToken,
            @RequestParam @DateTimeFormat(pattern = DateUtil.DATETIME_FORMAT) DateTime expirationDate) {
